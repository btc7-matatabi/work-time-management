...
export function ClockinHeader() {
  ...
  return (
    <div className="flex">
      ...
      <h3 className="scroll-m-20 p-6 text-2xl font-semibold tracking-tight">
        始業 終業時刻一覧
      </h3>
      <div className="p-6">
        <Select onValueChange={(value) => setDate(new Date(value))}>
          <SelectTrigger className="w-[180px] text-2xl bg-gray-50">
      ...
      <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight mt-5 mb-5 p-1 bg-yellow-300 rounded-l-lg">
        {workName[0].name}
      </h3>
      <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight mt-5 mb-5 mr-5 p-1 bg-gray-50  rounded-r-lg">
      ...
      <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight mt-5 mb-5 p-1 bg-green-300 rounded-l-lg">
        {workName[1].name}
      </h3>
